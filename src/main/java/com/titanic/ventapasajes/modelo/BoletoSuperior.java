...
@Entity
@Table(name = "pvm_boleto_superior")
public class BoletoSuperior implements Serializable{
    ...
    private FilaBoletoSuperior filaBoletoSuperior;
    ...
    public FilaBoletoSuperior getFilaBoletoSuperior() {
        return filaBoletoSuperior;
    }

    public void setFilaBoletoSuperior(FilaBoletoSuperior filaBoletoSuperior) {
        this.filaBoletoSuperior = filaBoletoSuperior;
    }
    ...
    public String toString() {
        return "BoletoSuperior{" +
                ...
                ", filaBoletoSuperior=" + filaBoletoSuperior +
